...
spd.dotPlot(sham,genes,:cluster; 
    fig_width=300, fig_height=300,  expr_cutoff=0.2)

cell1=collect(1:20)
cell2=["InjPT","TAL","vEC","HealthyPT","HealthyPT","Immune","TAL",
        "CD-PC","HealthyPT","gEC","Podo","TAL","TAL","Uro","TAL",
        "Fib","HealthyPT","JGA","DCT","CD-IC"]
sham.cells=spd.mapvalues(sham.cells, :cluster, :celltype, cell1, cell2);

save("new_sham_SpaData_tg2.jld2", "sham", sham)
...
hour4.cells=spd.mapvalues(hour4.cells, :cluster, :celltype, cell1, cell2);
save("new_hour4_SpaData_tg.jld2", "hour4", hour4)
...
hour12.cells=spd.mapvalues(hour12.cells, :cluster, :celltype, cell1, cell2);
save("new_hour12_SpaData_tg.jld2", "hour12", hour12)
...
day2.cells = spd.mapvalues(day2.cells, :cluster, :celltype, cluster, celltypes);
save("new_day2_SpaData_tg.jld2", "day2", day2)
...
week6.cells=spd.mapvalues(week6.cells, :cluster, :celltype, cell1, cell2);
save("new_week6_SpaData_tg.jld2", "week6", week6)
...
all_time=spd.mapvalues(all_time, :celltype,:celltype2, cell_order, cell_order2);
...
day2=spd.generate_polygon_counts(day2);
fig_day2=spd.plot_gene_polygons(day2, "Col1a1",cmap; x_lims=(0, maximum(day2.cells.x)+1000), y_lims=(0, maximum(day2.cells.y)+1000),
